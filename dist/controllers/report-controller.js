    ...
    static generateReport(req, res, next) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const fieldDelimiter = (_c = req.body) === null || _c === void 0 ? void 0 : _c.fieldDelimiter;
                const includeTotalizerRow = getKeyBoolean((_d = req.body) === null || _d === void 0 ? void 0 : _d.includeTotalizerRow);
                const unwindArrays = getKeyBoolean((_e = req.body) === null || _e === void 0 ? void 0 : _e.unwindArrays);
                const { xml: files } = req.files;
                const documents = getDocumentsFromFiles(files);
                const report = yield new report_1.Report(documents).generate(keys, excludeKeys, fieldDelimiter, includeTotalizerRow, unwindArrays);
                const attachment = {
                    name: 'report.csv',
